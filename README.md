...
- **[Achievement 2]** — e.g. shipped the RGB+thermal pedestrian detection pipeline to Jetson Orin Nano in production at Multiverse Computing. *(Add a metric if you have one — latency, accuracy, deployment scale.)*
- **[Achievement 3]** — e.g. MSc thesis at CERN/ETH Zürich: built an end-to-end dark matter search analysis pipeline using deep learning methods. *(Add grade/recognition/publication if applicable.)*

## Most-Prideful Builds

| Project | Your role & stack | Impact / Demo |
|---|---|---|
| algo-trading | Solo dev • Python — Kalman-filter hedge ratios, mean-reversion, options vol/gamma scalping, backtesting framework | github.com/aaguadob/algo-trading |
| Pedestrian detection (stereo RGB + thermal fusion) | ML Engineer • Python, YOLO, TensorRT, Jetson Orin Nano | [add demo/repo link if shareable] |
| Physics-informed neural networks (PINNs) | Solo dev • Python — teaching physics to PINNs | [in progress — add link once ready] |
| Emotion detection webapp | ML Engineer • Streamlit, LLM prompt engineering, LangChain/LangSmith | [add demo link if shareable] |

*Tip: keep this zero-effort for reviewers — live links over videos; videos over downloads.*

## Experience (TL;DR)
- **ML Engineer / Multiverse Computing** – [start date]–Present. Built production computer vision (stereo + thermal fusion, edge deployment on Jetson) and LLM-based emotion detection tooling.
- **MSc Thesis / CERN & ETH Zürich** – [dates]. End-to-end dark matter search analysis pipeline using AI/deep learning methods, as part of the TU Munich Applied and Engineering Physics program.
- Hackathons / OSS / Volunteering – [add anything relevant; algo-trading is open source at github.com/aaguadob/algo-trading if you want to list it here too]

## How I Work
- **Gets me pumped:** [fill in]
- **Disappoints me:** [fill in]
- **Strengths:** [fill in]
- **Improvement points:** [fill in]
- **Known behaviours / comms style:** [fill in]
